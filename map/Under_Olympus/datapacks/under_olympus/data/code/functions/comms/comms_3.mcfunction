...
execute if score commsTracker commsTimer matches 1 run summon minecraft:armor_stand -34.9 95.15 57 {Tags:["button_prop"],Rotation:[90.0f,0.0f],Marker:1,Invulnerable:1,NoGravity:1,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:warped_button",Count:1b}],DisabledSlots:2039583,Glowing:1}
execute if score commsTracker commsTimer matches 1 run team join red @e[tag=button_prop]
execute if score commsTracker commsTimer matches 1 run setblock -36 96 57 minecraft:warped_button[face=wall,facing=west,powered=false]
execute if score commsTracker commsTimer matches 1 run scoreboard players set musicTag tagList 0
execute if score commsTracker commsTimer matches 1 run scoreboard players set progressTracker advProgress 25
...
execute if score commsTracker commsTimer matches 60 run tellraw @a ["",{"text":"<","color":"white"},{"text":"Dr. Watney","color":"gold"},{"text":"> ","color":"white"},{"text":"Excellent! You just managed to make our whole scanning department operational again.","color":"white"}]

execute if score commsTracker commsTimer matches 200 run playsound minecraft:fx.comms.yes neutral @a ~ ~ ~ 100 1
execute if score commsTracker commsTimer matches 200 run tellraw @a ["",{"text":"<","color":"white"},{"text":"Dr. Watney","color":"gold"},{"text":"> ","color":"white"},{"text":"Use the button to call the elevator, it will take you up to the next floor.","color":"white"}]
...
execute if score commsTracker commsTimer matches ..399 run schedule function code:comms/comms_3 1t
