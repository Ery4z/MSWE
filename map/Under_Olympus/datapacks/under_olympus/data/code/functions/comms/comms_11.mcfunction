...
execute if score commsTracker commsTimer matches 1 run tellraw @a ["",{"text":"<","color":"white"},{"text":"Dr. Watney","color":"gold"},{"text":"> ","color":"white"},{"text":"Please make sure all of your collegues are in the airlock with you!","color":"white"}]

execute if score commsTracker commsTimer matches 140 run clear @a minecraft:poisonous_potato

execute if score commsTracker commsTimer matches ..139 run schedule function code:comms/comms_11 1t
