...
execute if entity @a[tag=broken] run clone 21 126 23 31 126 33 21 124 23

#ADJUST: clone original area to play area (masked)
execute if entity @a[tag=broken] run clone 21 122 23 31 122 33 21 126 23 masked

#ADJUST: clone bonus area to play area (masked)
execute if entity @a[tag=broken] run clone 21 124 23 31 124 33 21 126 23 masked
...
execute as @a[tag=!in-game] if entity @s[x=20,y=126,z=22,dx=12,dy=12,dz=12] run tag @s add in-game

#ADJUST: detect if player is out of play area
execute as @a[tag=in-game] unless entity @s[x=20,y=126,z=22,dx=12,dy=12,dz=12] run tag @s remove in-game

###PLAYER OUT OF BOUNDS PROTECTION------------------------------------------------------------------------

execute as @a[tag=!admin] unless entity @s[x=14,y=126,z=16,dx=24,dy=12,dz=24] run title @s actionbar {"text":"You went out of bounds!","color":"red"}
execute as @a[tag=!admin] unless entity @s[x=14,y=126,z=16,dx=24,dy=12,dz=24] run advancement grant @s[advancements={code:secrets/outofbounds=false}] only code:secrets/outofbounds
execute as @a[tag=!admin] unless entity @s[x=14,y=126,z=16,dx=24,dy=12,dz=24] run tp @s 26 126 36 180 0

###PLAYER START/RESET BUTTONS-----------------------------------------------------------------------------

#ADJUST: start (clone play area to bonus area)
execute as @e[type=armor_stand,tag=spawn,tag=start_level] run clone 21 126 23 31 126 33 21 124 23
...
execute as @e[type=armor_stand,tag=spawn,tag=stop_level] run clone 21 124 23 31 124 33 21 126 23 masked
execute as @e[type=armor_stand,tag=spawn,tag=stop_level] run data merge entity @e[type=armor_stand,tag=blockswap,x=26,y=126,z=30,dx=0,dy=0,dz=0,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:basalt",Count:1b}]}
execute as @e[type=armor_stand,tag=spawn,tag=stop_level] run data merge entity @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:poisonous_potato",Count:1b,tag:{CustomModelData:99}}]}
execute as @e[type=armor_stand,tag=spawn,tag=stop_level] run data merge entity @e[type=armor_stand,tag=crafter,x=30,y=126,z=26,dx=0,dy=0,dz=0,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:poisonous_potato",Count:1b,tag:{CustomModelData:99}}]}
execute as @e[type=armor_stand,tag=spawn,tag=stop_level] run data merge entity @e[type=armor_stand,tag=crafter_display,x=30,y=128.125,z=26,dx=0,dy=0,dz=0,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:poisonous_potato",Count:1b,tag:{CustomModelData:99}}]}
...
execute as @a[tag=reset_level] run clone 21 122 23 31 122 33 21 126 23
...
execute if block 34 126 19 warped_button[powered=true] run setblock 34 126 19 minecraft:warped_button[face=wall,facing=west,powered=false]

execute if block 35 94 20 warped_button[powered=true] if score timesStopped stopCounter matches 3.. if entity @e[tag=hint,tag=hint_taken] run tellraw @a ["",{"text":"Hint:","color":"red"},{"text":" you can click ","color":"white"},{"text":"this link","color":"gold","clickEvent":{"action":"open_url","value":"https://youtu.be/n9RIVp7K73A"}},{"text":" to view the solution of this level.","color":"white"}]
execute if block 35 94 20 warped_button[powered=true] if score timesStopped stopCounter matches 3.. if entity @e[tag=hint,tag=hint_taken] run tag @e[tag=hint,tag=hint_taken] add hint_add
execute if block 35 94 20 warped_button[powered=true] if score timesStopped stopCounter matches 3.. if entity @e[tag=hint,tag=!hint_taken] run tellraw @a ["",{"text":"Warning:","color":"red"},{"text":" pressing this button ","color":"white"},{"text":"again","color":"gold"},{"text":" will give you the solution for this level. Are you sure you want to use a hint?","color":"white"}]
execute if block 35 94 20 warped_button[powered=true] if score timesStopped stopCounter matches 3.. if entity @e[tag=hint,tag=!hint_taken] run tag @e[tag=hint,tag=!hint_taken] add hint_taken
execute if block 35 94 20 warped_button[powered=true] run setblock 35 94 20 minecraft:warped_button[face=wall,facing=south,powered=false]
...
execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] run playsound minecraft:fx.completed record @a ~ ~ ~ 100 1
execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] run title @a times 20 100 20
execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] run title @a subtitle {"text":"Track completed!","color":"gold"}
execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] run title @a title {"text":""}

execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] at @e[type=armor_stand,tag=robot] if entity @e[type=armor_stand,tag=spawn,tag=!finished] run particle minecraft:firework ~ ~1 ~ 0 0 0 0.1 40 force

execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] if score replayTag tagList matches 0 run scoreboard players set gameTag tagList 0
execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] if score replayTag tagList matches 0 run tag @a remove fastforward
execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] if score replayTag tagList matches 0 run tag @e[type=armor_stand,tag=spawn] remove fastforward
execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] if score replayTag tagList matches 0 if entity @e[tag=hint,tag=hint_add] run scoreboard players add hints hintsTaken 1

execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] if score replayTag tagList matches 0 run scoreboard players set progressTracker advProgress 30

execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] if score replayTag tagList matches 1 run tellraw @a {"text":"You finished a level in replay mode. Use the 'Exit level' button in your hotbar to return to the level selection area.","italic":true,"color":"gray"}

execute as @e[type=armor_stand,tag=blockswap,x=22,y=126,z=26,dx=0,dy=0,dz=0,nbt={ArmorItems:[{},{},{},{id:"minecraft:iron_block",Count:1b}]}] if entity @e[type=armor_stand,tag=spawn,tag=!finished] run tag @e[type=armor_stand,tag=spawn] add finished